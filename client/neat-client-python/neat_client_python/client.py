...
class NeatClient():
    def __init__(self, base_url, session: Session = Session()):
    ...
    def create_raw(self, data: CreateRawRequest, headers=DEFAULT_HEADERS) -> RawRespose:
        m = CreateRaw(data)
...
def main():
    client = NeatClient("http://127.0.0.1:8000/")
