    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_type', models.CharField(choices=[('normal', 'NORMAL'), ('graphql', 'GRAPHQL')], default='normal', help_text='请求类型', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response_type', models.CharField(choices=[('html', 'HTML'), ('plain', 'PlAIN'), ('css', 'CSS'), ('js', 'JS'), ('font', 'FONT'), ('img', 'IMG'), ('json', 'JSON'), ('jsonp', 'JSONP')], default='plain', help_text='响应类型', max_length=255)),
        ...
        migrations.AddConstraint(
            model_name='response',
            constraint=models.UniqueConstraint(fields=('url', 'raw'), name='unique_response'),
        ),
        migrations.AddConstraint(
            model_name='request',
