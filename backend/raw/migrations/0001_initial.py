    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_type', models.CharField(choices=[('normal', 'NOEMAL'), ('graphql', 'GRAPHQL')], default='normal', help_text='请求类型', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('schema', models.CharField(choices=[('http://', 'HTTP'), ('https://', 'HTTPS')], editable=False, max_length=255)),
